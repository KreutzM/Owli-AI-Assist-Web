...
const profiles = {
  schemaVersion: '1', defaultProfileId: 'basic', profiles: [{
    id: 'basic', label: 'Basic', description: 'Profile', availability: 'backend',
    transports: { backend: { available: true, supportsStreaming: false, supportsFollowup: false } },
  }],
};
